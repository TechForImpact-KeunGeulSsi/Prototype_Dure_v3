...
| 역할 | 이름 | 담당 |
|---|---|---|
| PM | 정병국 | 서비스 기획, 일정 관리, 이해관계자 소통 |
| UI/UX | 박수현 | 화면 설계, 에셋 선정, 디자인 시스템 |
| AI | 김준한 | 마루 프롬프트 설계, 카드 자동 생성, 리포트 생성 |
| FE | 노종현 | 도감 화면, 캐릭터 UI, 채팅 인터페이스 |
| BE | 김경원 | API 설계, 데이터 구조, AI 연동 |

**파트너**: (주)다로리인 / 서삼열 대표 / 경북 청도군 화양읍

---

## 라이선스

본 프로젝트는 한양대학교 테크포임팩트 2026 캡스톤 프로젝트로 제작된 프로토타입입니다.
